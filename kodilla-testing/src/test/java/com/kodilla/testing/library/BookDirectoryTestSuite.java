...
//    }
    ...
    void testlistBooksInHandsOf0book() {
        ...
        when(bookLibrary.listBooksInHandsOf(any()))
                .thenReturn(theEmptyList);
        //When
        List<Book> result = bookLibrary.listBooksInHandsOf(new LibraryUser());
    ...
    void testlistBooksInHandsOf1book() {
        ...
        when(libraryDatabaseMock.listBooksWithCondition("ZeroBooks"))
                .thenReturn(theEmptyList);
        when(libraryDatabaseMock.listBooksWithCondition("xxx"))
                .thenReturn(theListOf1);
        when(libraryDatabaseMock.listBooksWithCondition("Zero"))
                .thenReturn(theListOf5);
        //When
        List<Book> emptyList = bookLibrary.listBooksWithCondition("ZeroBooks");
        List<Book> listOf1 = bookLibrary.listBooksWithCondition("xxx");
        List<Book> listOf5 = bookLibrary.listBooksWithCondition("Zero");
